...
void __fastcall TConfiguration_F::Timer_СHClick(TObject *Sender)
{
  if(this->check_saving(this->Timer_СH->Tag, this->Timer_СH->Checked) == true)
  {
  this->flag_Timer = false;
  this->Button_enabled();
  }
