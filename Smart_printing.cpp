...
// Configuration_F->Timer_ÑH->Checked                              = _Robik_config->get_Timer();
...
void TGeneral_F::apple_general_program()
{
 ...
 _Robik_config->set_Timer(Configuration_F->Timer_ÑH->Checked);
...
Memo1->Lines->Add("Èìÿ: " + AnsiString(Pr[i].pPrinterName));
Memo1->Lines->Add("Ïîðò: " + AnsiString(Pr[i].pPortName));
Memo1->Lines->Add("Äðàéâåð: " + AnsiString(Pr[i].pDriverName));
Memo1->Lines->Add("");
}
}
delete Pr;
