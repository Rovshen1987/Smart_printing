 ...
 string time_r::get_time()
{
 ...
 return result;
  ...
  if ((this->visable_hour == true) && (this->visable_minut == true) && (this->visable_second == true)&&(this->Paralysis == true))
 {
  std::string null_t = "";
 ...
 result = null_t+std::to_string(this->hour)+":"+create_null_text(this->minut)+
		":"+create_null_text(this->second);
 return result;
 };
...
void time_r::set_Paralysis(const bool& value)
{
